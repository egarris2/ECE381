...
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x480000A0u)

/* IOPINS0_8 Address: CYREG_PRT15_DM0 Size (bytes): 8 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x480000A8u)
...
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x480000B8u)
